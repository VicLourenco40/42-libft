...
#    Updated: 2025/06/04 12:58:57 by vde-albu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJ = ft_isalpha.o ft_isdigit.o ft_isalnum.o ft_isascii.o ft_isprint.o \
	  ft_isspace.o ft_strlen.o ft_max.o ft_min.o ft_abs.o ft_memset.o \
	  ft_bzero.o ft_memcpy.o ft_memmove.o ft_strlcpy.o ft_strlcat.o \
	  ...
	  ft_printf.o print.o ft_get_next_line.o
